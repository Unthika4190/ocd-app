                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ...
                      จะต้องนำเทคโนโลยีดิจิทัลและเทคโนโลยีปัญญาประดิษฐ์มาใช้ในการบริหารจัดการองค์การเพื่อการให้บริการแก่ประชาชน
                    </p>
                    <a
                      href="assets/PMQA 4.0-1-24.pdf"
                      target="blank"
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ปรัชญาการคิดเชิงออกแบบ UX/UI
                      เพื่อการเปลี่ยนแปลงและการพัฒนาองค์การในภาครัฐ
                    </p>
                    <a
                      href="assets/PMQA 4.0-25-32.pdf"
                      target="blank"
                      rel="noopener noreferrer"
                      className="btn btn-primary"
                    >
            ...
            <div className="card mb-4">
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <h2 className="card-title">ปรัชญาการคิด เชิงวิพากษ์</h2>
                    <p className="card-text">
                      ปรัชญาการคิด เชิงวิพากษ์
                      เพื่อการเปลี่ยนแปลงและการพัฒนาองค์การในภาครัฐในยุคดิจิทัล
                    </p>
                    <a
                      href="assets/PMQA 4.0-33-41.pdf"
                      target="blank"
                      rel="noopener noreferrer"
                      className="btn btn-primary"
                    >
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ลักษณะสำคัญขององค์การเพื่อพัฒนาคุณภาพการบริหารจัดการภาครัฐในยุคดิจิทัลเเละ
                      AI
                    </p>
                    <a
                      href="assets/PMQA 4.0-42-57.pdf"
                      target="blank"
                      rel="noopener noreferrer"
                      className="btn btn-primary"
                    >
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <a
                      href="assets/PMQA 4.0-58-63.pdf"
                      target="blank"
                      rel="noopener noreferrer"
                      className="btn btn-primary"
                    >
