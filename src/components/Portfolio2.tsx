        ...
        <div className="container">
          ...
          <div className="row">
              ...
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/organization intervention1-41.pdf "
                      target="_blank"
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                <a href="#">
                  <img className="card-img-top" src="images/p11.jpg" alt="" />
                </a>
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/organization intervention42-45.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <p className="card-text">
                    การปรับโครงสร้างองค์กรหมายถึงกระบวนการการปรับโครงสร้างลำดับชั้น
                    โครงสร้างภายใน หรือขั้นตอนการดำเนินงานของบริษัท บริษัทต่างๆ
                    ดำเนินการปรับโครงสร้างเพื่อบรรลุเป้าหมายบางประการเช่น
                    เพื่อให้สามารถแข่งขันได้มากขึ้นหรือตอบสนองต่อการปับเปลี่ยนแปลงในตลาด
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/organization intervention46-111.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/organization intervention112-142.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      กลยุทธ์การเเข่งขันเเละการมีส่วนร่วม
                    </a>
                  </h4>
                  <p className="card-text">
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Technostructural 1-32.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      การออกเเบบงาน
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Technostructural 33-54.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      การ Coaching
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Technostructural 55-77.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      การสร้างทีมงาน
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Technostructural 78-123.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <p className="card-text">
                    การเปลี่ยนแปลงวัฒนธรรมองค์กรคือกระบวนการพัฒนาวัฒนธรรมองค์กรของคุณในรูปแบบที่แท้จริง
                    ซึ่งดึงดูดผู้คนและสร้างแรงบันดาลใจให้ทีมทำงานได้อย่างเต็มประสิทธิภาพ
                    เป็นเรื่องของการกำหนดและปลูกฝังพฤติกรรมที่ต้องการและปรับปรุงประสบการณ์ของพนักงานเพื่อเพิ่มการมีส่วนร่วม
                    การรักษาพนักงาน ขวัญกำลังใจ
                    และท้ายที่สุดช่วยให้คุณบรรลุวิสัย
                  </p>
                </div>
              </div>
            </div>
